...
| Android TV | [Download the APK](https://sipario.tv/download/tv) | 1.26.0 | [android-tv-v1.26.0](https://github.com/Aiml3ss/sipario-releases/releases/tag/android-tv-v1.26.0) |
<!-- versions:table:end -->

Android TV users can also open Downloader and enter code **5358756**.

<!-- versions:apk-note:begin -->
The current APK is version `1.26.0`.
...
Sipario-TV.apk (android-tv-v1.26.0)
sha256 d9a69ec3d8580a1ca238011f5d1e3a8c5212738101b0f77812494f8ba06f4cfe
```
