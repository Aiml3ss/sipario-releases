...
| Android TV | [Download the APK](https://sipario.tv/download/tv) | 1.25.2 | [android-tv-v1.25.2](https://github.com/Aiml3ss/sipario-releases/releases/tag/android-tv-v1.25.2) |
<!-- versions:table:end -->

Android TV users can also open Downloader and enter code **5358756**.

<!-- versions:apk-note:begin -->
The current APK is version `1.25.2`.
...
Sipario-TV.apk (android-tv-v1.25.2)
sha256 1f0d78618cbb3acc5124cf0cfbdda40bf97f3a41058c5fb8b90427ee768c23ba
```
