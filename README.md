...
| Android TV | [Download the APK](https://github.com/Aiml3ss/sipario-releases/releases/latest/download/Sipario-TV.apk) | 1.7.8 | [android-tv-v1.7.8](https://github.com/Aiml3ss/sipario-releases/releases/tag/android-tv-v1.7.8) |
<!-- versions:table:end -->
...
The current APK is version `1.7.8`.
...
Sipario-TV.apk (android-tv-v1.7.8)
