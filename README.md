...
| Android TV | [Download the APK](https://sipario.tv/download/tv) | 1.29.2 | [android-tv-v1.29.2](https://github.com/Aiml3ss/sipario-releases/releases/tag/android-tv-v1.29.2) |
<!-- versions:table:end -->

Android TV users can also open Downloader and enter code **5358756**.

<!-- versions:apk-note:begin -->
The current APK is version `1.29.2`.
...
Sipario-TV.apk (android-tv-v1.29.2)
sha256 692c2f2e8e719f29a309605df927c21465219d7564a9735a9fe9f6bf6ce7e018
```
